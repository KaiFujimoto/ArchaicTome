...
brook = User.create!(email: 'brook@strawhats.com', first_name: 'Brook', last_name: 'SoulKing', password:'starwars', birth_date: Faker::Date.between(50.years.ago, Date.today), gender: 'M')
